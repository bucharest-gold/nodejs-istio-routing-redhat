...
oc new-app --template=nodejs-istio-routing-redhat-client-service -p SOURCE_REPOSITORY_URL=https://github.com/nodeshift-starters/nodejs-istio-routing-redhat -p SOURCE_REPOSITORY_REF=8.x -p SOURCE_REPOSITORY_DIR=routing-client
oc new-app --template=nodejs-istio-routing-redhat-service-a-service -p SOURCE_REPOSITORY_URL=https://github.com/nodeshift-starters/nodejs-istio-routing-redhat -p SOURCE_REPOSITORY_REF=8.x -p SOURCE_REPOSITORY_DIR=routing-service-a
oc new-app --template=nodejs-istio-routing-redhat-service-b-service -p SOURCE_REPOSITORY_URL=https://github.com/nodeshift-starters/nodejs-istio-routing-redhat -p SOURCE_REPOSITORY_REF=8.x -p SOURCE_REPOSITORY_DIR=routing-service-b
```
